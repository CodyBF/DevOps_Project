...
const testDBUrl =
	"mongodb+srv://agile2:ufbmw916Vmro0rQm@communityconnect.byt2uem.mongodb.net/?retryWrites=true&w=majority"; // Your test database URL
...
describe("Event Data Functions", () => {
	let testDB;
	before(async () => {
		const client = new MongoClient(testDBUrl, {
	...
	describe("updateEvent", () => {
		it("should update an existing event", async () => {
			...
			expect(updatedEvent).to.have.property(
				"description",
				"Updated Description"
			);
		});
